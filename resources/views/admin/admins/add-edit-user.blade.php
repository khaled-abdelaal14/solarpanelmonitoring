          ...
          <div class="card-body">
            ...
            <div class="row">
              <div class="col-12">
                ...
                <form name="subadminform" id="subadminform" @if(empty($subadmindata->id)) action="{{url('admin/add-edit-user')}}" @else action="{{url('admin/add-edit-user',$subadmindata->id)}}" @endif method="POST" enctype="multipart/form-data" >
                    @csrf
                    <div class="card-body">
                      ...
                      <div class="form-group col-6">
                        ...
                        <input style="background-color: #d4d4d4" type="email"  required   class="form-control" value="{{$subadmindata->email ?? ""}}"  id="email" name="email" placeholder="email">
                      </div>
